...
slug: /reference/recording-files/
---
...
somewhere else can set that in [Project Configuration](../configuration/project.md).
...
Running `omegaflow recording=release` validates every member, then builds the
