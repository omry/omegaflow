...
Browser capture also requires the dependencies described in
[Install And Supported Platforms](../getting-started/install.md). You can build
the silent workflow before configuring narration.
...
- [Recording files](../reference/recording-files/index.md)
- [Build and check](../reference/cli/build-check.md)
- [Watch](../reference/cli/watch.md)
- [Video output](../reference/output/presentation.md)
