#!/usr/bin/env python3
"""Generate cached narration audio from OmegaFlow Studio scripts."""
...
def narration_yaml_text(
    ...
    lines = [
        "# @package narration",
        "# Generated by OmegaFlow Studio action=sync_narration.",
...
def encode_multipart_form(
    ...
    *,
    boundary: str = "omegaflow-studio-boundary",
) -> tuple[bytes, str]:
    chunks: list[bytes] = []
