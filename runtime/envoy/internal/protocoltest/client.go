...
func (client *Client) Execute(operationID, source string, policy protocol.ExecutionPolicy) ([]byte, error) {
	return client.send(protocol.Execute{
		Seq: client.nextSeq, OperationID: operationID, Source: source,
...
func (client *Client) Finalize(operationID, reason string) ([]byte, error) {
	return client.send(protocol.Finalize{Seq: client.nextSeq, OperationID: operationID, Reason: reason})
}
