...
assertion still sees it, while `exec` replaces the image and leaves no status at
all, closing the operation's range and letting the replacing program keep the
terminal until the recording drains. Planned
