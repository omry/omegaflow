...
including syntax-bearing persistent aliases, and source containing the exact
bracketed-paste terminator must be rejected
before start. Prove Bash and exec'd descendants inherit no
