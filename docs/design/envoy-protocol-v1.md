...
environment name, including an application-provided `INPUTRC`, a matching and
mismatching handshake `session_id`, every startup and control-write deadline
epoch, and resize placement before, between,
