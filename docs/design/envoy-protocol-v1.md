...
| Output marks per operation | 100,000 |
...
carrying `output_through`. It coalesces otherwise. Marks never regress in
...
time instead, and no other event is retimed. Sender-stamped realtime output
