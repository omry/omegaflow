---
kind: video
id: terminal-highlight-ranges-demo
title: Terminal Text Highlights
description: Show highlight syntax and apply exact-text and regular-expression targets.
capture:
  window_size: 80x20
  timeout: 50
style:
...
beat:
  ...
  panes:
    ...
    - id: target-results
      actions:
      - id: show-status
        run: python3 recordings/terminal-highlight-ranges-demo/status_demo.py
